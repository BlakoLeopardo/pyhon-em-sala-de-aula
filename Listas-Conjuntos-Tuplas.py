...
frutas = {"Maça", "laranja", "banana", "coco", "banana", "banana"} # Se for uma lista, bote o nome em plural



# Você pode contar a quantidade de vezes que um valor e econtrado em uma lista com:
print(frutas.count("abacaxi"))
# Pode-se retornar o index de um valor na lista
# print(frutas.index("coco"))
# Para limpar uma lista usa-se .clear()
# frutas.clear()
